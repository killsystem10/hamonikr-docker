...
RemoveFormat		: "서식 지우기",
InsertLinkLbl		: "링크",
InsertLink			: "링크 삽입/변경 (Ctrl+L)",
RemoveLink			: "링크 삭제",
VisitLink			: "링크 열기",	//MISSING
Anchor				: "책갈피 삽입/변경",
AnchorDelete		: "고정 제거",	//MISSING
InsertImageLbl		: "이미지",
...
DecreaseIndent		: "내어쓰기",
IncreaseIndent		: "들여쓰기",
Blockquote			: "인용구",	//MISSING
CreateDiv			: "Div 컨테이너 만들기",	//MISSING
EditDiv				: "Div 컨테이너 편집",	//MISSING
DeleteDiv			: "Div 컨테이너 제거",	//MISSING
Undo				: "취소 (Ctrl+Z)",
Redo				: "재실행 (Ctrl+Y)",
...
PageBreakLbl		: "페이지 분할",	//MISSING
PageBreak			: "페이지 분할 삽입",	//MISSING
...
FitWindow		: "편집기 최대화 (Ctrl+Alt+Enter)",
ShowBlocks		: "블록 보기",	//MISSING
...
VisitLinkBlocked	: "새로운 창을 열 수 없습니다. 팝업이 차단되어 있는지 확인하여 보십시오.",	//MISSING
...
DlgGenClass			: "스타일 시트 클래스",
DlgGenTitle			: "자문 제목",
DlgGenContType		: "자문 콘텐츠 유형",
DlgGenLinkCharset	: "링크된 리소스 캐릭터셋",
DlgGenStyle			: "스타일",
...
DlgImgAlign			: "정렬",
DlgImgAlignLeft		: "왼쪽",
DlgImgAlignAbsBottom: "줄아래",
DlgImgAlignAbsMiddle: "줄중간",
...
DlgLnkTargetFrameName	: "대상 프레임 이름",
...
DlgLnkPopDependent	: "종속 (Netscape)",
DlgLnkPopWidth		: "너비",
DlgLnkPopHeight		: "높이",
DlgLnkPopLeft		: "왼쪽 위치",
DlgLnkPopTop		: "윗쪽 위치",
...
DlgButtonType		: "버튼종류",
DlgButtonTypeBtn	: "버튼",	//MISSING
DlgButtonTypeSbm	: "제출",	//MISSING
...
DlgLstStart			: "시작",	//MISSING
DlgLstType			: "종류",
DlgLstTypeCircle	: "원",
DlgLstTypeDisc		: "디스크",	//MISSING
DlgLstTypeSquare	: "사각형",
...
DlgDocCharSetCE		: "중앙 유럽",	//MISSING
DlgDocCharSetCT		: "중국어 번체 (Big5)",	//MISSING
DlgDocCharSetCR		: "키릴 문자",	//MISSING
DlgDocCharSetGR		: "그리스어",	//MISSING
DlgDocCharSetJP		: "일본어",	//MISSING
DlgDocCharSetKR		: "한국어",	//MISSING
DlgDocCharSetTR		: "터키어",	//MISSING
DlgDocCharSetUN		: "유니코드 (UTF-8)",	//MISSING
DlgDocCharSetWE		: "서유럽",	//MISSING
...
DlgDocCText			: "텍스트",
DlgDocCLink			: "링크",
DlgDocCVisited		: "방문한 링크",
DlgDocCActive		: "활성화된 링크",
...
// About Dialog
DlgAboutAboutTab	: "관하여",
DlgAboutBrowserInfoTab	: "브라우저 정보",
DlgAboutLicenseTab	: "라이센스",	//MISSING
DlgAboutVersion		: "버전",
...
DlgDivStyle		: "스타일",	//MISSING
DlgDivInlineStyle	: "인라인 스타일"	//MISSING
};
