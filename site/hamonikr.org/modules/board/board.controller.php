...
class boardController extends board
{
	...
	function procBoardInsertDocument()
	{
		...
		//새글 등록시 슬랙 알람
		//$message = $obj->user_name." 님이 새글을 등록했습니다. 제목: (" .$obj->title.") ";
		$message = $obj->user_name."님이 새글을 등록했습니다. 제목:(<https://hamonikr.org/".$obj->mid."/".$obj->document_srl."|".$obj->title.">)"; 

		$data = array(
				"channel" => "#hamonikr_alarm",
				"username" => "하모니카 커뮤니티",
				"text" => $message,
				"icon_emoji" => ":ghost:"
		...
		//$url = "https://hooks.slack.com/services/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";
		$url = "https://hooks.slack.com/services/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";
	...
	curl_setopt($ch, CURLOPT_POSTFIELDS, 'payload='.$json);       //POST data
	 
	$response = curl_exec($ch);
	//echo "<script>console.log( 'PHP_Console: " . $obj . "' );</script>";
	curl_close($ch);
