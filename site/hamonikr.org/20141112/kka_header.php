...
function Del(T){if(confirm("삭제하시겠습니까?")){document.location.href="proc.php?Kdiv=desk_del&tid="+T;}}
//-->
</script>
    ...
    <div id="header-wrapper" >
        ...
        <div id="header-container" class="container">
            ...
            <div id="header-logo">
                <a href="/">
                                <img src="http://xe.hamonikr.org/files/attach/images/194/28c4bef00c6940e04d363504b7ef8ab3.png" alt="logo" title="index.php" /><script>
//<![CDATA[
var current_url = "http://xe.hamonikr.org<?=$_SERVER['PHP_SELF'];?>";
...
<?}?>
                        ...
                        <form action="http://xe.hamonikr.org/" method="post" class="iSearch"><input type="hidden" name="error_return_url" value="<?=$_SERVER['PHP_SELF'];?>?<?=$_SERVER['QUERY_STRING'];?>" />
                                                        <input type="hidden" name="mid" value="<?=$_SERVER['PHP_SELF'];?>" />
			...
			<ul id="gnb" class="sf-menu">
				<li class="current"><a href="/index.php?mid=page_jBcr78">홈으로</a>
									</li><li><a href="/20141112/korean_bs.php">한글화서비스</a>
					<ul >
						<li><a href="/index.php?mid=page_bPzp37">한글화 도움말</a>
                        	                        </li><li><a href="/20141112/my_list.php">내가 참여한 한글화</a>
                        	                        </li><li><a href="/20141112/korean_bs.php">패키지별 한글화</a>
                        	<ul>
					...
					<ul >
						<li><a href="/index.php?mid=board_hzVL42&amp;category=453">인터넷 뱅킹</a>
                        	<ul>
                                <li><a href="/index.php?mid=board_hzVL42">인터넷 뱅킹 (전체)</a></li>                            </ul>                        </li><li><a href="/index.php?mid=board_IUmu37">인터넷 쇼핑</a>
                        	                        </li><li><a href="/index.php?mid=board_aMBI05">나의 데스크탑</a>
                        	                        </li><li><a href="/index.php?mid=board_bFBk25">팁 & 테크</a>
                        	                        </li><li><a href="/index.php?mid=board_KtxL32">배경화면</a>
                        	                        </li><li><a href="/index.php?mid=refer_url">하모니카가 소개된 곳</a>
                        	                        </li>					</ul>				</li><li><a href="/index.php?mid=terms_of_use">이용 약관</a>
									</li>			</ul>
